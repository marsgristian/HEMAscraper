...
# Criar um novo arquivo corpus_sentences_openai_eng.jsonl com as traduções usando OpenAI
...
# Configurações
CHECKPOINT_FILE = '/HEMAscraper/Scripts/checkpoint_openai_eng.json'
OUTPUT_FILE = '/HEMAscraper/Scripts/corpus_sentences_openai_eng.jsonl'
...
print(f"Iniciando processamento OpenAI para inglês...")
        ...
        for line in input_file:
            ...
            try:
                ...
                if data['lang'] == 'it':
                    ...
                    print(f"[OpenAI-ENG] Processando {italian_lines_found}/{total_italian_lines} - linha {current_line}")
                    
                    # Traduzir o texto para o inglês usando OpenAI
                    ...
                    if traducao:
                        ...
                        translated_count += 1
                        print(f"[OpenAI-ENG] Traduzido ({translated_count})")
                    else:
                    ...
                    if translated_count % 10 == 0:
                        ...
                        print(f"Checkpoint OpenAI-ENG salvo - {translated_count}/{total_italian_lines}")
...
print("Processamento OpenAI para inglês concluido")
...
if translated_count >= total_italian_lines:
    if os.path.exists(CHECKPOINT_FILE):
        ...
        print("Checkpoint OpenAI-ENG removido") 